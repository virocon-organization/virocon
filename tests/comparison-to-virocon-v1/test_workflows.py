...
def refdata_dnvgl_hstz():
    with np.load("tests/comparison-to-virocon-v1/reference_data/DNVGL/reference_data_DNVGL.npz") as npz_file:
...
def refdata_omae2020_vhs():
    with np.load("tests/comparison-to-virocon-v1/reference_data/OMAE2020/reference_data_OMAE2020.npz") as data:
        data_dict = dict(data)
...
def refdata_wes_sigmau():
    with np.load("tests/comparison-to-virocon-v1/reference_data/WES4/reference_data_WES4.npz") as npz_file:
        data_dict = dict(npz_file)
