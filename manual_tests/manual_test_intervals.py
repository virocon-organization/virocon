...
ref_intervals = [[1.2], [1.5, 2.4, 2.5], [2.6, 3.1, 3.5], [3.6, 4.0, 5.0]]
ref_centers = [np.median(inter) for inter in ref_intervals]
ref_boundaries = [[1.2, 1.2], [1.5, 2.5], [2.6, 3.5], [3.6, 5.0]]
...
ref_intervals = [[1.2, 1.5, 2.4], [2.5, 2.6, 3.1], [3.5, 3.6, 4.0], [5.0]]
ref_centers = [np.median(inter) for inter in ref_intervals]
ref_boundaries = [[1.2, 2.4], [2.5, 3.1], [3.5, 4.0], [5.0, 5.0]]
...
ref_centers = [np.median(inter) for inter in ref_intervals]
ref_boundaries = [[1.5, 2.5], [2.6, 3.5], [3.6, 5.0]]
