...
from virocon.contours import calculate_alpha, ISORMContour
...
plt.figure()
plt.plot(my_coordinates[:, 1], my_coordinates[:, 0], label="my ISORM")
plt.plot(ref_coordinates[:, 1], ref_coordinates[:, 0], label="ref ISORM")
plt.legend()
