...
# sample. The lognormal distribution's scale parameter
# is set to be dependent on the random variable with index 0,
# which represents significant wave height. A 3-parameter
# exponential function is chosen to define the dependency by
# setting the function to 'exp3'. The dependency for each
# parameter must be given in the order shape, location and scale.
