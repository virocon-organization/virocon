...
htmlhelp_basename = 'ViroCondocdoc'
...
latex_documents = [
    (master_doc, 'ViroCondoc.tex', 'ViroCon doc Documentation',
     'SWTP', 'manual'),
]
...
man_pages = [
    (master_doc, 'virocondoc', 'ViroCon doc Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ViroCondoc', 'ViroCon doc Documentation',
     author, 'ViroCondoc', 'One line description of project.',
     'Miscellaneous'),
]
